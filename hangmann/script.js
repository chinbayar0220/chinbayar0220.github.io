    ...
    const words = [
        ...
        { word: "ЭРДЭНЭЧУЛУУН", hint: "Тэр бол чойролтын их хаан." },
        { word: "ЭРДЭНЭЧУЛУУН", hint: "Түүний хамгийн сайн найз бол компьютер тоглоом." },
        { word: "ЭРДЭНЭЧУЛУУН", hint: "Хамгийн анхдагч чойрогч." },
    ];
    ...
    function pickRandomWord() {
        ...
        revealLetterBtn.disabled = false;
        revealLetterBtn.textContent = 'Hint (1)';
    }
